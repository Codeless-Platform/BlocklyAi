...
/* eslint-disable */
/*
This is an Immediately Invoked Function Expression (IIFE) that defines a module.
It determines how the Blockly module should be loaded based on the environment (AMD, Node.js, or Browser).
*/
(function (root, factory) {
    ...
    "use strict";
    /*
    This section defines color-related Blockly blocks, such as color pickers, random color, RGB color, and color blending.
    The color-related constants are also defined, with a default hue of 20.
    */
    Blockly.Blocks.colour = {};
    Blockly.Constants = {};
    Blockly.Constants.Colour = {};
    Blockly.Constants.Colour.HUE = 20;          // default hue of 20
    ...
    /*
    This section defines list-related Blockly blocks, such as creating an empty list, repeating items in a list,
    reversing a list, checking if a list is empty, and getting the length of a list.
    The list-related constants are also defined, with a default hue of 260.
    */
    ...
    /*
    These blocks: Blockly.Blocks.lists_create_with = { ... };
                  Blockly.Blocks.lists_create_with_container = { ... };
                  Blockly.Blocks.lists_create_with_item = { ... };
    define the structure for creating lists with Blockly.
    The lists_create_with block allows users to create a list with a specified number of items.
    */
    ...
    /*
    These blocks: Blockly.Blocks.lists_indexOf = { ... };
                  Blockly.Blocks.lists_getIndex = { ... };
    provide functionality related to indexing lists,
    such as finding the index of an item in a list and getting values from a list at a specific index.
    */
    ...
    /*
    This section initializes the logic-related Blockly blocks, and it sets the hue color to 210.
    */
    Blockly.Blocks.logic = {};
    Blockly.Constants.Logic = {};
    Blockly.Constants.Logic.HUE = 210;
    /* This block represents a boolean value (true or false). */
    Blockly.defineBlocksWithJsonArray([
        {
            type: "logic_boolean",
            message0: "%1",
        ...
        /* These blocks represent if statements and if-else statements.
        They allow conditional execution of code based on boolean values.
        */
        {
            type: "controls_if",
        ...
        /* This block represents comparison operations (equal, not equal, less than, less than or equal, greater than, greater than or equal). */
        {
            type: "logic_compare",
            message0: "%1 %2 %3",
            args0: [
        ...
        /* This block represents logical operations (AND or OR) on boolean values. */
        {
        ...
        /* This block represents the negation (NOT) of a boolean value. */
        {
            type: "logic_negate",
        ...
        /* This block represents a null check. */
        ...
        /* This block represents a ternary conditional operation (a simplified if-else statement). */
        {
            type: "logic_ternary",
    ...
    Blockly.defineBlocksWithJsonArray([
        /* example: %{BKY_CONTROLS_IF_IF_TOOLTIP} is a placeholder tooltip.
        It might be replaced with the translated tooltip text for an "if" block when Blockly is used in a language other than English.
        So we can use blockly international with many supported languages
        */
    ...
    Blockly.defineBlocksWithJsonArray([
        {
            ...
            args0: [{ type: "input_value", name: "TIMES", check: "Number" }], // check refers to boolean
...
Blockly.defineBlocksWithJsonArray([
    {
        ...
        "message0": "Load External Dataset %1",
        "args0": [
            {
                "type": "field_input",
                "name": "FILENAME",
    ...
    Blockly.defineBlocksWithJsonArray([
        {
            type: "NN_Regression",
            tooltip: "Neural Network Regression",
            setHelpUrl: "https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.LinearRegression.html",
            message0: "NN_Regression",
            style: "logic_blocks",
            mutator: "CLR_mutator",
            output: "Sklearn_Model"
        }
    ...
    Blockly.defineBlocksWithJsonArray([
        {
        "type": "unsupervised_training",
        "message0": "Training input: %1 %2",
        "args0": [
            {
                "type": "field_input",
                "name": "Training_input",
    ...
    Blockly.defineBlocksWithJsonArray([
        {
            ...
            "message0": "K-means Clustering %1 Dataset Path %2 %3 Data Preprocessing %4 Model Training %5 Model Evaluation %6 Model Prediction %7 Visualization %8 n_clusters= %9",
            "args0": [
                {
                    "type": "input_dummy"
                },
    ...
    Blockly.defineBlocksWithJsonArray([
        {
            "type": "prediction",
            "message0": "Make Prediction with input data: %1",
            "args0": [
                {
                    "type": "field_input",
                    "name": "input_data",
    ...
    Blockly.defineBlocksWithJsonArray([
        {
            "type": "input_output",
            "message0": "Input variable %1 , Output variable %2 , Target column %3 %4",
            "args0": [
              {
                "type": "field_input",
                "name": "input_variable",
...
//////////////////////////////////////Fiting Blocks////////////////////////////////////////////////////
    Blockly.defineBlocksWithJsonArray([
        {
            "type": "fit",
            "message0": "Fit model with training data: %1, labels: %2, epochs: %3, verbose: %4",
            "args0": [
              {
                "type": "field_input",
                "name": "X_train",
    ...
    Blockly.defineBlocksWithJsonArray([
        {
            "type": "evaluate",
            "message0": "Evaluate model data: %1, labels: %2",
            "args0": [
              {
                "type": "field_input",
                "name": "X_test",
    ...
    Blockly.defineBlocksWithJsonArray([
        {
            "type": "compile",
            "message0": "optimizer: %1 loss: %2 metrics: %3",
            "args0": [
              {
                "type": "field_dropdown",
                "name": "optimizer",
    ...
    Blockly.defineBlocksWithJsonArray([
        {
            "type": "data_split",
            "message0": "Split variables into :  %1 , %2 , %3 , %4 , %5",
            "args0": [
              {
                "type": "field_input",
                "name": "X_train",
...
Blockly.defineBlocksWithJsonArray([
    ...
    {
        "type": "mae",
        "message0": "Mean Absolute Error %1",
        "args0": [
          {
            "type": "input_value",
            "name": "metric",
...
Blockly.defineBlocksWithJsonArray([
    {
        "type": "training",
        "message0": "Training input : %1 Training output :  %2 %3",
        "args0": [
          {
            "type": "field_input",
            "name": "Training_input",
